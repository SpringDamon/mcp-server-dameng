...
- The bin scripts are at ./bin/ (relative to this directory), not at .trae/skills/gstack/bin/.
  Replace any references to .trae/skills/gstack/bin/ with ./bin/ when running commands.
- Replace any references to .trae/skills/gstack/bin/gstack-slug with ./bin/gstack-slug.
